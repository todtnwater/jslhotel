...
public class QnaListAdmin implements CommonExecute {
	...
	public void execute(HttpServletRequest request) {
		...
		/* 페이징 */
		int totalCount = dao2.getQnaCount(select, type, search);
		...
		List<QnaDto> dtos = dao.getQnaList(select, order, type, search, start, end);
