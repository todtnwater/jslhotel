...
<main>
    <div class="membership-detail-container">
	    ...
	    <!-- 전체 내용 -->
	    <div class="detail-content-wrapper gold-theme">
	        ...
	        <div class="detail-top-section">
	            ...
	            <div class="card-info-area">
	                <div class="info-block">
	                    <h2 class="grade-name">Gold 회원권</h2>
	                </div>
	                <div class="info-block">
	                	<strong>가격</strong>
	                    <p>₩600,000</p>
	        ...
	        <div class="detail-middle-section">
	            ...
	            <h3>골드 멤버십 쿠폰</h3>
	            <ul class="benefit-list-detail">
	                <li>석식 뷔페 30% 할인 쿠폰</li>
	                <li>바 20% 할인 쿠폰</li>
	                <li>북카페 1만 원 할인 쿠폰</li>
	                <li>기타 어뮤니티 50% 할인 쿠폰</li>
	                <li>호텔 내 올리브O 할인 쿠폰</li>
	                <li>관광지 쿠폰북</li>
	            </ul>
	        </div>
        ...
        <div class="final-button-group">
            <a href="javascript:goSubscribe('gold')" class="subscribe-button">멤버십 구독하기</a>
