...
<%@ include file = "../common/menu_manager.jsp" %>
	...
	<script>
		...
		function goList(){
			...
			qnaWork.method = "post";
			qnaWork.action = "Manager";
			qnaWork.submit();
		}
		
		function goUpdateAnswer(){
			writeForm.t_page.value = "manager";
        ...
        <div class="write-container minW800">
            ...
            <form class="write-form" name="writeForm">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" id="postTitle" name="t_title" value = "${dto.getQ_title()}" readonly>
                </div>

                <div class="form-group full-width">
                    <label for="postContent">내용</label>
                    <textarea id="postContent" name="t_content" rows="10" readonly>${dto.getQ_content()}</textarea>
                </div>
